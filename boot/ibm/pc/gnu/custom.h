  ...
  COMMAND LINE: "./ftangle ./custom -uSUN -mANSI -mCC -mSYS_NAME= MSDOS/GNU -mF_CALLS= 1 -mPREFIX_END_CHR= '\\' -mNULL_NAME= NUL -= /u/krommes/fweb/1.53/boot/ibm/pc/gnu/custom.h -# -v"
