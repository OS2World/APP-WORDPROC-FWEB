  ...
  COMMAND LINE: "./ftangle ./custom -uCONFIG -mCONFIG -mCC -= /u/krommes/fweb/1.53/web/custom.h.in -# -v"
...
/*  (The flag |HAVE_GETENV| is set automatically in config.h by ./configure.) */
...
#define NULL_FILE_NAME  "NIL:"/* For Unix systems. */
...
/*  (The flag |HAVE_TMPNAM| is set automatically in config.h by ./configure.) */

/*  (The flag |HAVE_TEMPNAM| is set automatically in config.h by ./configure.) */
...
/*  (The flag |FANCY_SPLIT| is set automatically in config.h by ./configure.) */
...
/*  (The flag |HAVE_STDLIB_H| is set automatically in config.h by ./configure.) */


/*  (The flag |HAVE_STDARG_H| is set automatically in config.h by ./configure.) */
...
/*  (The flag |HAVE_STDDEF_H| is set automatically in config.h by ./configure.) */

/* Other stuff handled by autoconf. */

/*  (The flag |HAVE_STRING_H| is set automatically in config.h by ./configure.) */


/*  (The flag |HAVE_MEMORY_H| is set automatically in config.h by ./configure.) */


/*  (The flag |HAVE_FLOAT_H| is set automatically in config.h by ./configure.) */
...
/*  (The flag |HAVE_LIMITS_H| is set automatically in config.h by ./configure.) */

/*  (The flag |HAVE_VALUES_H| is set automatically in config.h by ./configure.) */
...
/*  (The flag |ANSI_CTYPE_H| is set automatically in config.h by ./configure.) */
...
/*  (The flag |HAVE_STD_PROTOTYPES| is set automatically in config.h by ./configure.) */
...
/*  (The flag |OLD_PROTOTYPES| is set automatically in config.h by ./configure.) */

/* ANSI also introduces the type |void|.  If your compiler doesn't \
understand the constructions |void *| and |void fcn()|, define |NO_VOID|. */


/*  (The flag |NO_VOID| is set automatically in config.h by ./configure.) */
...
/*  (The flag |ANSI_SPRINTF| is set automatically in config.h by ./configure.) */

/* The ANSI |sscanf| does some cute things with scansets, but it doesn't \
always work. */

/*  (The flag |ANSI_SSCANF| is set automatically in config.h by ./configure.) */
...
/*  (The flag |CLOCK_T_DEFINED| is set automatically in config.h by ./configure.) */
...
/*  (The flag |HAVE_GETTIMEOFDAY| is set automatically in config.h by ./configure.) */
...
/*  (The flag |HAVE_SYS_TIMEB_H| is set automatically in config.h by ./configure.) */
