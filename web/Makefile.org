...
# --- FWEB MAKE FILE (v. 1.50) ---

# NOTE:  The procedures for using this make file were changed beginning
# with v1.30. 
...
# If you are not a Unix user, DO NOT PROCEED for v1.50, as the following
# system-specific bootstrap procedures have not been tested and upgraded for
# this version.
...
# make. This is because some of the makes on the personal computers didn't work
# correctly with some of the more sophisticated commands.
