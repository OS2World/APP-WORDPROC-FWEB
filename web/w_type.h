  ...
  COMMAND LINE: "web/ftangle web/w_type -A -# --F -= 1.53/web/w_type.h"
...
#include "s_type.h" /* Prototypes for \.{style}. */
#include "c_type.h" /* Prototypes for \.{common.web}. */
#include "p_type.h" /* Prototypes for \.{prod.web}. */
#include "d_type.h" /* Prototypes for \.{reserved.web}. */
