...
#define SET_COLOR(field) set_color(wt_style.color.field.value)
#define CLR_PRINTF(field,args) SET_COLOR(field); printf args; fflush(stdout); \
...
#define FATAL(origin, msg1, msg2) fatal(ERR_##origin, OC(msg1), OC(msg2)) \

#define CONFUSION(msg1,msg2) confusion(OC(msg1),OC(msg2)) \
...
#define BTRANS mod_trans(OC("beginning in module"),module_count)
#define MTRANS mod_trans(OC("module"),module_count) /* String including section 
and \
						page info. */
#define MTRANS0 mod_trans(OC(""),module_count)
#define MOD_TRANS(mnum) mod_trans(OC("module"), mnum) \
